...
<template>
  <main class="flex flex-col min-h-screen w-full bg-black p-3">
    <div class="flex-1 flex flex-col items-center w-full">
      ...
      <div
        v-if="hasData"
        class="w-full max-w-6xl flex-1 flex flex-col md:flex-row gap-4 items-start"
      >
            ...
            <table class="w-full text-gray-300 bg-gray-900 rounded text-md">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    {{ store.decodedMetar.altimeter?.value }}
                    {{ store.decodedMetar.altimeter?.unit }}
                  </td>
                </tr>
